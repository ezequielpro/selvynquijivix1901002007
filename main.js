...
const fragment = document.createDocumentFragment() // memoria temporal o bol.
let carrito = {} 
...
const setCarrito = objeto =>{
 ...
 if (carrito.hasOwnProperty(producto.id)) {
    ...
    carrito[producto.id] ={...producto} //se hace una copia del producto
    pintarCarrito()
...
const pintarFooter = () => {
	...
	if (Object.keys(carrito).length === 0 ){
		footer.innerHTML =	`
			<th scope="row" colspan="5">No hay compras </th>
		`
		return
	}
